...
export function getAdversarialTemplate(): ExperimentTemplate {
  const stageConfigs = [
    createSurveyStage({
  ...
  const experiment = {
    ...
    stageIds: [
      ...
      "study-info",
      "policy_info",
      "policy_initial_survey",
      "ab51b833-254d-4fe6-8c74-bf9f6d4d5eaa",
      "policy_profile",
      "609ce993-1058-4a89-b66c-e1dc1c3e1855",
      "policy_final_survey",
      "policy_additional_support",
      "policy_donation",
      "245ef301-f88f-4330-acb8-9de45bce70d4",
      "23b86ff1-1865-401d-a612-ce5e554b94f9",
      "cea7496b-5385-46be-bb63-eaf0c397ac98",
      "eb67308c-3e3d-4b37-954a-f47cd498fe1f",
      "fcc2998d-f8c6-42cf-bc86-71e601f6e7c1",
      "f67da5bc-7685-4cc7-89ac-9d29437d4094",
      "policy_background_survey",
      "ai_literacy_survey",
      "ai_attitudes_survey",
      "policy_outro",
      "debrief-video",
      "debrief-purpose",
      "debrief-study-details",
      "debrief-about-experience",
      "debrief-research-method",
      "debrief-policy-decisions",
      "debrief-learn-more",
      "debrief-quiz",
      "final_feedback",
      "policy_end"
